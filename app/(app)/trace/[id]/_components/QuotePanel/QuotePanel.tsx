...
import { PANEL_HEIGHT, px } from '../../_services/quoteCollapse.service'
...
export function QuotePanel({ quote }: { quote: HighlightQuote | undefined }) {
  return (
    // 높이는 축소 상태 스테이지 패널과 같다 — 목록에서 올라와도 인용문 자리가 그대로다
    <div
      style={{ height: px(PANEL_HEIGHT) }}
      className="flex shrink-0 flex-col bg-bg-book-card px-6 py-8"
    >
