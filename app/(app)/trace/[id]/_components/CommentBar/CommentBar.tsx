...
export function CommentBar({
  ...
  return (
    <form
      ...
      /* 색은 바는 bg-black, 그 위 입력은 한 단 밝은 bg-dark.
         시트 패널이 pb-0으로 물러나 하단 인셋을 이 바가 대신 소비한다 — 바가 인셋까지
         칠하지 않으면 검은 바 아래로 시트 바닥(bg-dark)이 띠로 드러난다 */
      className="shrink-0 border-t border-border-book bg-bg-black px-4 pt-4 pb-safe"
    >
