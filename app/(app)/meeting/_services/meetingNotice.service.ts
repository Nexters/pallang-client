...
/**
 * 만들기/수정/초대 참여 화면이 목록으로 돌아온 뒤 스낵바를 한 번 띄우기 위한 표시.
...
export type MeetingNoticeKind = 'created' | 'updated' | 'joined'
...
export function consumeMeetingNotice(): MeetingNoticeKind | null {
  ...
  if (value === 'created' || value === 'updated' || value === 'joined') return value
  return null
}
